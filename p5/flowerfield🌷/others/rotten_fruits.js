...
function draw() {
  ...
  if (frameCount % 60 == 0) {
    ...
    var b = new Fruit(xpos_arr[counter], ypos_arr[counter], 15, 204, 0, 15);
    balls.push(b);
  }
...
//codified trees
//add info page/UI
//data: map tsne result to a circle
//topiicmodeling: color dif identity hate